...
Além disso, há um limite para o número de nós que uma única instância do Unified Manager pode monitorar antes de instalar uma segunda instância do Unified Manager. Para obter mais informações, consulte link:https://www.netapp.com/pdf.html?item=/media/13504-tr4621pdf.pdf["Guia de práticas recomendadas do Unified Manager"^]
