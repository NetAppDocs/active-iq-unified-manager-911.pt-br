...
Por exemplo, se a versão instalada for o OnCommand Unified Manager 9,5 e você quiser atualizar para a versão mais recente do Active IQ Unified Manager 9,11, siga uma sequência de atualizações.
