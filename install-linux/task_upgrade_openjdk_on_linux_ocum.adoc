...
Você pode atualizar as versões do OpenJDK dentro das famílias de lançamento. Por exemplo, você pode atualizar do OpenJDK 11.0.9 para o OpenJDK 11,0.14, mas não pode atualizar diretamente do OpenJDK 11 para o OpenJDK 12.
