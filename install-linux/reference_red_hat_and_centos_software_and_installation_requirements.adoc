...
* Red Hat Enterprise Linux versão 7.x e 8.x baseado na arquitetura x86_64.
...
* MySQL Community Edition versão 8.0.28 (do repositório MySQL).
* OpenJDK versão 11.0.14 (do repositório Red Hat extra Enterprise Linux Server)
* Python 3,6.x
