...
Você pode atualizar as versões do OpenJDK dentro das famílias de lançamento. Por exemplo, você pode atualizar do OpenJDK 11.0.12 para o OpenJDK 11,0.13, mas não pode atualizar diretamente do OpenJDK 11 para o OpenJDK 12.
...
. Copie os diretórios e arquivos do diretório resultante `jdk` (por exemplo, `jdk-11.0.13` para o local onde o Java está instalado. Exemplo: `C:\Program Files\NetApp\JDK\`
